...
if (isset($_POST["wijzigen"])) {
    ...
    <tr><td><input type="text" name="email" value="' . $row["email"] . '"></td></tr>
    <span class="label-text text-white">Voornaam</span>
    <tr><td><input type="text" name="voornaam" value="' . $row["voornaam"] . '"></td></tr>
    <span class="label-text text-white">Naam</span>
    <tr><td><input type="text" name="naam" value="' . $row["naam"] . '"></td></tr>
    <span class="label-text text-white">Wachtwoord</span>
    <tr><td><input type="text" name="wachtwoord" value=" '. $row["wachtwoord"] .' "></td></tr>
    <span class="label-text text-white">Status</span>
    <tr><td><input type="text" name="status" value=" '. $row["status"] .' "></td></tr>
    ...
    <tr><td><input type="text" name="bechrijving" value="' . $row["beschrijving"] .' " class="input input-bordered input-lg w-full max-w-xs"></td></tr>
